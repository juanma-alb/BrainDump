      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-3 md:py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
          ...
          <div className="text-center sm:text-left">
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white tracking-tight transition-colors">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto gap-2 md:gap-3 px-1 sm:px-0 py-1">
            <button
              onClick={toggleTheme}
            ...
            <button
              ...
              className="shrink-0 rounded-full bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 px-4 md:px-6 py-2 md:py-2.5 text-xs md:text-sm font-semibold hover:bg-gray-200 dark:hover:bg-slate-700 transition-all duration-200 ease-out hover:-translate-y-0.5 active:scale-[0.98]"
            >
              <span className="hidden sm:inline">← Todas las notas</span>
