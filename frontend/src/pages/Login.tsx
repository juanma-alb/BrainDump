...
function Login() {
  ...
  // Estado que controla la transición mágica entre la Bienvenida y el Formulario
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa] dark:bg-[#111111] transition-colors duration-500 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        {!showForm ? (
          /* ================= PANTALLA DE BIENVENIDA (Estilo iCloud) ================= */
          <div className="flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-700">
            {/* Ícono central abstracto */}
            <div className="relative w-32 h-32 mb-8">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500 to-purple-500 rounded-3xl rotate-6 opacity-20 blur-xl"></div>
              <div className="relative w-full h-full bg-gradient-to-tr from-blue-500 to-purple-600 rounded-[2rem] shadow-2xl flex items-center justify-center">
            ...
            <button
              ...
              className="px-8 py-3.5 bg-black dark:bg-white text-white dark:text-black font-semibold rounded-full text-lg shadow-lg hover:scale-105 transition-all duration-300 active:scale-95 mb-10"
            >
              Iniciar sesión
            </button>
