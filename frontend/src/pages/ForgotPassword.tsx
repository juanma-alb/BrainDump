    ...
    <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl border border-white/50 dark:border-slate-700/50 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] rounded-[2.5rem] p-8 md:p-10 animate-in slide-in-from-bottom-8 fade-in duration-500">
      {!isSuccess ? (
        <>
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-tr from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-full mb-4">
              <svg className="w-8 h-8 text-gray-400 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              />
              {errors.email && <p className="mt-1.5 text-sm text-red-600 dark:text-red-400 font-medium px-2">{errors.email.message}</p>}
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-4 px-6 text-white font-semibold rounded-2xl transition-all duration-200 active:scale-[0.98] bg-gray-800 hover:bg-black disabled:bg-gray-400 disabled:cursor-not-allowed shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_8px_25px_rgba(0,0,0,0.3)]"
              >
                {isSubmitting ? (
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-slate-800 text-center">
            <Link to="/" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium transition-colors duration-200">
              Cancelar y volver
            </Link>
          </div>
        </>
        ...
        <div className="text-center py-4 animate-in zoom-in-95 duration-500">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">¡Correo Enviado!</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-2">Hemos enviado un enlace de recuperación a tu correo electrónico.</p>
          <p className="text-sm text-gray-500 dark:text-gray-500 mb-8 px-2">Por favor revisa tu bandeja de entrada o carpeta de spam y sigue las instrucciones.</p>
          <button onClick={() => navigate('/')} className="w-full py-4 px-6 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 text-gray-900 dark:text-white font-semibold rounded-2xl transition-all duration-200 active:scale-[0.98]">
